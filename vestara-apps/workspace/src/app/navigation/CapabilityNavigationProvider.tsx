...
export function CapabilityNavigationProvider({ children, apiBaseUrl = '/api' }: CapabilityNavigationProviderProps) {
  const client = useMemo(() => new WorkspaceApiClient(apiBaseUrl), [apiBaseUrl]);
